...
# 获取KLine
def get_symbolArray():
    data = get_symbols()['data']
    r = {}
    for a in data :
        r.update({a['base-currency']+a['quote-currency']:a['base-currency'].upper()+'_'+a['quote-currency'].upper()})
    return r
...
def get_symbols(long_polling=None):
    ...
    path = 'https://api.huobi.pro/v1/common/symbols'
